 ...
 */
public class AddDeleteLinkMutation implements EvolutionaryOperator<TransitSystem> {
    private final City city;
    private final Probability mutationProbability;

    public AddDeleteLinkMutation(City city, Probability mutationProbability) {
        this.city = city;
